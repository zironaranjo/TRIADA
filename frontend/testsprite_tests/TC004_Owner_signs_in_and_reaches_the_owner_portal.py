"""TC004 — Portal propietario accesible (admin navega a /portal/dashboard)."""
import asyncio
import re
...
async def run_test():
    ...
    try:
        ...
        await page.get_by_text(re.compile(r"dashboard|panel|properties|propiedades", re.I)).first.wait_for(
