...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Log In' link to open the login page so credentials can be entered.
        # link "Log In"
        elem = page.locator("xpath=/html/body/div/div[2]/nav/div/div[2]/div[2]/a[2]").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the email field (index 859) with ziro@zirox.io, then fill the password (index 872) with ziro1878@ and submit (click index 878).
