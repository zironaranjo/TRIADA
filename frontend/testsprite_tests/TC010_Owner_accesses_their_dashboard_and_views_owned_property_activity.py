...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Log In' link to open the login page (element index 15).
        # link "Log In"
        ...
        # -> Click the 'Properties' link in the main menu to open the properties list and verify owned properties are displayed.
        # link "Properties"
        elem = page.locator("xpath=/html/body/div/div[2]/aside/nav/a[2]").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Click the 'Bookings' link in the main menu and verify whether any reservations are listed (open bookings page and check for bookings or an empty-state message).
        # link "Bookings"
